...
public class LookAndFeelsComboBoxBeanInfo extends SimpleBeanInfo {
    ...
    private static final int PROPERTY_itemCount = 59;
    private static final int PROPERTY_itemListeners = 60;
    private static final int PROPERTY_keyListeners = 61;
    private static final int PROPERTY_keySelectionManager = 62;
    private static final int PROPERTY_layout = 63;
    private static final int PROPERTY_lightweight = 64;
    private static final int PROPERTY_lightWeightPopupEnabled = 65;
    ...
    private static final int PROPERTY_maximumRowCount = 70;
    ...
    private static final int PROPERTY_popupMenuListeners = 88;
    private static final int PROPERTY_popupVisible = 89;
    ...
    private static final int PROPERTY_prototypeDisplayValue = 93;
    private static final int PROPERTY_registeredKeyStrokes = 94;
    private static final int PROPERTY_renderer = 95;
    private static final int PROPERTY_requestFocusEnabled = 96;
    private static final int PROPERTY_rootPane = 97;
    private static final int PROPERTY_selectedIndex = 98;
    private static final int PROPERTY_selectedItem = 99;
    private static final int PROPERTY_selectedLookAndFeel = 100;
    ...
    private static final int METHOD_addLookAndFeel9 = 9;
    ...
    private static final int METHOD_getIndexOfLookAndFeel59 = 59;
    private static final int METHOD_getInsets60 = 60;
    private static final int METHOD_getItemAt61 = 61;
    ...
    private static final int METHOD_hidePopup75 = 75;
    private static final int METHOD_imageUpdate76 = 76;
    private static final int METHOD_insertItemAt77 = 77;
    private static final int METHOD_insets78 = 78;
    private static final int METHOD_inside79 = 79;
    private static final int METHOD_intervalAdded80 = 80;
    private static final int METHOD_intervalRemoved81 = 81;
    private static final int METHOD_invalidate82 = 82;
    private static final int METHOD_isAncestorOf83 = 83;
    private static final int METHOD_isFocusCycleRoot84 = 84;
    private static final int METHOD_isLightweightComponent85 = 85;
    private static final int METHOD_keyDown86 = 86;
    private static final int METHOD_keyUp87 = 87;
    private static final int METHOD_layout88 = 88;
    ...
    private static final int METHOD_removeAllItems126 = 126;
    private static final int METHOD_removeItem127 = 127;
    private static final int METHOD_removeItemAt128 = 128;
    private static final int METHOD_removeLookAndFeel129 = 129;
    ...
    private static final int METHOD_selectedCurrentLookAndFeel147 = 147;
    private static final int METHOD_selectWithKeyChar148 = 148;
    ...
    private static final int METHOD_showPopup154 = 154;
    ...
    private static MethodDescriptor[] getMdescriptor(){
        ...
        try {
            ...
            methods[METHOD_getItemAt61] = new MethodDescriptor(javax.swing.JComboBox.class.getMethod("getItemAt", new Class[] {int.class})); // NOI18N
            methods[METHOD_getItemAt61].setDisplayName ( "" );
            ...
            methods[METHOD_hidePopup75] = new MethodDescriptor(javax.swing.JComboBox.class.getMethod("hidePopup", new Class[] {})); // NOI18N
            methods[METHOD_hidePopup75].setDisplayName ( "" );
            ...
            methods[METHOD_insertItemAt77] = new MethodDescriptor(javax.swing.JComboBox.class.getMethod("insertItemAt", new Class[] {java.lang.Object.class, int.class})); // NOI18N
            methods[METHOD_insertItemAt77].setDisplayName ( "" );
            ...
            methods[METHOD_intervalAdded80] = new MethodDescriptor(javax.swing.JComboBox.class.getMethod("intervalAdded", new Class[] {javax.swing.event.ListDataEvent.class})); // NOI18N
            methods[METHOD_intervalAdded80].setDisplayName ( "" );
            methods[METHOD_intervalRemoved81] = new MethodDescriptor(javax.swing.JComboBox.class.getMethod("intervalRemoved", new Class[] {javax.swing.event.ListDataEvent.class})); // NOI18N
            methods[METHOD_intervalRemoved81].setDisplayName ( "" );
            methods[METHOD_invalidate82] = new MethodDescriptor(java.awt.Container.class.getMethod("invalidate", new Class[] {})); // NOI18N
            methods[METHOD_invalidate82].setDisplayName ( "" );
            methods[METHOD_isAncestorOf83] = new MethodDescriptor(java.awt.Container.class.getMethod("isAncestorOf", new Class[] {java.awt.Component.class})); // NOI18N
            methods[METHOD_isAncestorOf83].setDisplayName ( "" );
            methods[METHOD_isFocusCycleRoot84] = new MethodDescriptor(java.awt.Container.class.getMethod("isFocusCycleRoot", new Class[] {java.awt.Container.class})); // NOI18N
            methods[METHOD_isFocusCycleRoot84].setDisplayName ( "" );
            methods[METHOD_isLightweightComponent85] = new MethodDescriptor(javax.swing.JComponent.class.getMethod("isLightweightComponent", new Class[] {java.awt.Component.class})); // NOI18N
            methods[METHOD_isLightweightComponent85].setDisplayName ( "" );
            methods[METHOD_keyDown86] = new MethodDescriptor(java.awt.Component.class.getMethod("keyDown", new Class[] {java.awt.Event.class, int.class})); // NOI18N
            methods[METHOD_keyDown86].setDisplayName ( "" );
            methods[METHOD_keyUp87] = new MethodDescriptor(java.awt.Component.class.getMethod("keyUp", new Class[] {java.awt.Event.class, int.class})); // NOI18N
            methods[METHOD_keyUp87].setDisplayName ( "" );
            methods[METHOD_layout88] = new MethodDescriptor(java.awt.Container.class.getMethod("layout", new Class[] {})); // NOI18N
            methods[METHOD_layout88].setDisplayName ( "" );
            methods[METHOD_list89] = new MethodDescriptor(java.awt.Component.class.getMethod("list", new Class[] {})); // NOI18N
            methods[METHOD_list89].setDisplayName ( "" );
            methods[METHOD_list90] = new MethodDescriptor(java.awt.Component.class.getMethod("list", new Class[] {java.io.PrintStream.class})); // NOI18N
            methods[METHOD_list90].setDisplayName ( "" );
            methods[METHOD_list91] = new MethodDescriptor(java.awt.Component.class.getMethod("list", new Class[] {java.io.PrintWriter.class})); // NOI18N
            methods[METHOD_list91].setDisplayName ( "" );
            methods[METHOD_list92] = new MethodDescriptor(java.awt.Container.class.getMethod("list", new Class[] {java.io.PrintStream.class, int.class})); // NOI18N
            methods[METHOD_list92].setDisplayName ( "" );
            methods[METHOD_list93] = new MethodDescriptor(java.awt.Container.class.getMethod("list", new Class[] {java.io.PrintWriter.class, int.class})); // NOI18N
            ...
            methods[METHOD_processKeyEvent118] = new MethodDescriptor(javax.swing.JComboBox.class.getMethod("processKeyEvent", new Class[] {java.awt.event.KeyEvent.class})); // NOI18N
            ...
            methods[METHOD_removeAllItems126] = new MethodDescriptor(javax.swing.JComboBox.class.getMethod("removeAllItems", new Class[] {})); // NOI18N
            methods[METHOD_removeAllItems126].setDisplayName ( "" );
            methods[METHOD_removeItem127] = new MethodDescriptor(javax.swing.JComboBox.class.getMethod("removeItem", new Class[] {java.lang.Object.class})); // NOI18N
            ...
            methods[METHOD_showPopup154] = new MethodDescriptor(javax.swing.JComboBox.class.getMethod("showPopup", new Class[] {})); // NOI18N
            methods[METHOD_showPopup154].setDisplayName ( "" );
            ...
            methods[METHOD_updateUI163] = new MethodDescriptor(javax.swing.JComboBox.class.getMethod("updateUI", new Class[] {})); // NOI18N
